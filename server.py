...
with sqlite3.connect('arlo.db') as conn:
    ...
    c.execute("CREATE TABLE IF NOT EXISTS devices (ip text, serialnumber text, hostname text, status text, register_set text, friendlyname text, armed text)")
        ...
        while True:
            ...
            if msg != None:
                ...
                if (msg['Type'] == "registration"):
                    ...
                    device.send_initial_register_set(WIFI_COUNTRY_CODE, VIDEO_ANTI_FLICKER_RATE, VIDEO_QUALITY_DEFAULT, device)
